...
def find_overlaps(ref_country, exons, country_name, output_dir='/work/users/g/a/gabivla/lab/SV_mosquitos/overlap_analysis_repetitive_regions'):
    ...
    exon_seqids = exons['chrom'].to_list()
    ...
    # Save to CSV file
    output_path = os.path.join(output_dir, f'{country_name}_overlaps_repetitive_ref.csv')
...
country = sys.argv[1]
# repetitive region
repetitive_region = '/overflow/dschridelab/users/rrlove/aedes/refs/aegy/unified_mask/merged_rep_map_masks.110822.bed'
repetitive_region = read_data_annotation(repetitive_region)
repetitive_region = pl.from_pandas(repetitive_region)
print(repetitive_region)
...
# VCF reference
reference_vcf = '/work/users/g/a/gabivla/lab/SV_mosquitos/VCF_genotypes_TEs/separate_chromosomes_windows_reference/merged_reference/VCF_reference_TEs_post_processing_600_absence_evidence.csv'
...
# Find overlaps
find_overlaps(df_reference, repetitive_region, country)
