...
df_nonref = df_nonref.loc[:, ~df_nonref.columns.str.contains("Unnamed")]
df_nonref = df_nonref.rename(columns=rename_dict_nonref)
...
plt.savefig('joint_sfs_all_countries_nonreference.svg')
plt.close()