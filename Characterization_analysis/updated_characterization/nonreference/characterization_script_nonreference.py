...
def plot_TE_counts(df):
    ...
    plt.title('Top TEs by Percentage per Country', fontsize=30)
...
def plot_PCA_data(df):
    ...
    #fig.legend(title="Country", loc='center left', bbox_to_anchor=(1.01, 0.5), fontsize=30, title_fontsize=30)

    # Adjust layout to make room for the legend
    plt.tight_layout(rect=[0, 0, 0.85, 1])

    # Save the figure
    plt.savefig('PCA_nonreference.svg', bbox_inches='tight')
    plt.close()
