...
def run_mcclintock(fastq_path_general, files_fastq, mcclintock_path, genome_path, consesus_te_path):
    for fastq in files_fastq:
        ...
        if '_1.fastq.gz' in fastq:
            ...
            fastq_2 = fastq
            print(f'{name}')
            print(f'sbatch -p general -n 24 --mem=200G -t 9-00:00:00 --mail-type=BEGIN,END,FAIL --mail-user=gabivla@email.unc.edu --wrap="python {mcclintock_path} -p 24 -r {genome_path} -c {consesus_te_path} -1 {fastq_1}  -2 {fastq_2} -o /work/users/g/a/gabivla/lab/SV_mosquitos/running_mcclintock/general_srr/output_{name} -m trimgalore,map_reads,temp2,ngs_te_mapper2,retroseq"')
            #os.system(f'sbatch -p general -n 24 --mem=200G -t 9-00:00:00 --mail-type=BEGIN,END,FAIL --mail-user=gabivla@email.unc.edu --wrap="python {mcclintock_path} -p 24 -r {genome_path} -c {consesus_te_path} -1 {fastq_1}  -2 {fastq_2} -o /work/users/g/a/gabivla/lab/SV_mosquitos/running_mcclintock/general_srr/output_{name} -m trimgalore,map_reads,temp2,ngs_te_mapper2,retroseq"')
...
def main():
    ...
    #fastq_folder_path = ['/work/users/g/a/gabivla/data_mosquito/data_running_mcclintock/SRR_run_genome_test/multiple_srr_genomes/fastq_v4/SRR11006823', '/work/users/g/a/gabivla/data_mosquito/data_running_mcclintock/SRR_run_genome_test/multiple_srr_genomes/fastq_v4/SRR11006824', '/work/users/g/a/gabivla/data_mosquito/data_running_mcclintock/SRR_run_genome_test/multiple_srr_genomes/fastq_v4/SRR11006828', '/work/users/g/a/gabivla/data_mosquito/data_running_mcclintock/SRR_run_genome_test/multiple_srr_genomes/fastq_v4/SRR11006830']
    
    #srr_ids = ['SRR11006829', 'SRR11006825', 'SRR11006826', 'SRR11006827', 'SRR11006821', 'SRR11006820', 'SRR11006767', 'SRR11006768', 'SRR11006769']
    srr_ids = ['SRR11006850']
    fastq_folder_path = [f'/work/users/g/a/gabivla/data_mosquito/data_running_mcclintock/SRR_run_genome_test/multiple_srr_genomes/fastq_v6/{srr}' for srr in srr_ids]
