...
for i, country in enumerate(countries):
    ...
    all_dfs_nonref[country] = frequency_df

for country1, country2 in country_pairs_nonref:
    country_vcf_dict_nonref[(country1, country2)] = (all_dfs_nonref[country1], all_dfs_nonref[country2])
...
for i, (pair, vcf_tuple) in enumerate(country_vcf_dict_nonref.items()):
    ...
    print('FST values calculated for', country1, country2)
    fst_pop1_pop2.to_csv(f'/work/users/g/a/gabivla/lab/SV_mosquitos/FST_analysis/TEs_absence_evidence/FST_values_{country1}_{country2}_nonref.csv', index=False)