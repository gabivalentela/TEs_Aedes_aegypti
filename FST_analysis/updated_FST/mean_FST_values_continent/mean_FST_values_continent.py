...
# continents
American = ['Brazil', 'Colombia', 'USA']
African = ['Gabon', 'Kenya', 'Senegal']
print(ref_df.loc[American, American])
print(ref_df.loc[African, African])
# get average FST values for each continent
mean_FST_American = ref_df.loc[American, American].mean().mean()
mean_FST_African = ref_df.loc[African, African].mean().mean()
print(f'mean_FST_American - ref: {mean_FST_American}')
print(f'mean_FST_African - ref: {mean_FST_African}')

# nonreference
print(nonref_df.loc[American, American])
print(nonref_df.loc[African, African])
# get average FST values for each continent
mean_FST_American = nonref_df.loc[American, American].mean().mean()
mean_FST_African = nonref_df.loc[African, African].mean().mean()
print(f'mean_FST_American - nonref: {mean_FST_American}')
print(f'mean_FST_African - nonref: {mean_FST_African}')