...
def main():
    ...
    non_ref_dict_dd = Making_vcf.make_nonref_retroseq_df(non_ref_list_of_bed)
    ...
    for i, (country_nonref, df_country_nonref) in enumerate(nonref_country.items()):
        ...
        # making VCF file
        vcf_file = Making_vcf.make_vcf(te_content_all_genomes_nonref_SNPcheck)
        vcf_files_no_filtering[country_nonref] = vcf_file
        ...
        vcf_files_filtering[country_nonref] = vcf_file
    ...
    outfile = open('number_of_TEs_filtered_non-reference.txt', 'a')
